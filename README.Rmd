...
[![Codecov test coverage](https://codecov.io/gh/RMI-PACTA/pacta.interactive.plot/branch/master/graph/badge.svg)](https://codecov.io/gh/RMI-PACTA/pacta.interactive.plot?branch=master)
...
[![pacta.interactive.plot status badge](https://2degreesinvesting.r-universe.dev/badges/pacta.interactive.plot)](https://2degreesinvesting.r-universe.dev)
...
You can install the development version of pacta.interactive.plot from [R-universe](https://r-universe.dev) with:

``` r
install.packages("pacta.interactive.plot", repos = "https://rmi-pacta.r-universe.dev")
```

You can install the development version of pacta.interactive.plot from [GitHub](https://github.com/RMI-PACTA/pacta.interactive.plot) with:
